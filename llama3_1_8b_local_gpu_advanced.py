...
def run_query_pipeline_with_llama(faiss_index, log_data, user_query, hour=12, status=200, size_mb=0.01, day='Monday', top_k=5):
...
def user_friendly_system():
    ...
    while True:
        ...
        response = run_query_pipeline_with_llama(faiss_index, log_data, user_query, hour, status, size_mb, day, top_k)
